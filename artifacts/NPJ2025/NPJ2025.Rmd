...
author: 
  - name          : "Matthew J. Cooper Borkenhagen"
    corresponding : yes
    affiliation   : 1, 2
    email         : "mcooperborkenhagen@fsu.com"
...
## Additional Details
The simulation and analysis code can all be found in the project’s Github repository (github.com/XXX). Additional information can be found in the appendix and data for the project can be found in OSF (https://osf.io/qvu8m/?view_only=a17142c524924219ad3951ac85324d8e).
...
read_csv("data/table_3.csv") %>% 
  apa_table(caption = "Distribution of Mean Squared Error for Train and Generalization Sets",
            note = "Error is provided in raw form and standardized form. The standardized form appears in parentheses, where standardization happens relative to the generalization set as in other analyses here. These values are calculated across all words in each set (train and generalization), collapsing across representational capacity conditions.")
...
Data and code in order to reproduce all analyses included here can be found at the project's page on the Open Science Framework (https://osf.io/qvu8m/?view_only=a17142c524924219ad3951ac85324d8e).
...
## Notes on the Estimation of Linear Mixed Effects Models
...
In addition to the subsampling procedure and following the steps in Brauer & Curtin (2018), we also used the "bound optimization by quadratic approximation" optimizer implemented in the $lmer()$ function in the lme4 package in R (Bates et al., 2015). The procedure for the sampling procedure and for all other analyses can be found in the project's OSF repository (https://osf.io/qvu8m/?view_only=a17142c524924219ad3951ac85324d8e). Note that in the code, "ensemble" is indicated with the variable "model_id" and "representational capacity" is associated with the variable name "hidden_units".
