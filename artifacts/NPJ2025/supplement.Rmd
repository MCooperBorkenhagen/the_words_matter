...
## Detecting variation in the parameter estimates when fitting lmer()
Note that this process uses only a subset of the data given the scale of the full dataset:
```{r}
